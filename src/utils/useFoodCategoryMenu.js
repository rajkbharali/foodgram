...
const useFoodCategoryMenu = (id1, id2) => {
  ...
  async function fetchFoodList() {
    const data = await fetch(
      `https://thingproxy.freeboard.io/fetch/https://www.swiggy.com/dapi/restaurants/list/v5?lat=12.9351929&lng=77.62448069999999&collection=${id2}&tags=layout_CCS_${
