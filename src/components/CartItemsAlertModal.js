    ...
    <div className="fixed left-0 top-0 bg-black bg-opacity-50 w-screen h-screen flex justify-center items-center">
      <div className="bg-white rounded-lg shadow-md p-8 w-[40%]">
        ...
        <div className="flex justify-between items-center">
          <Link to="/cart">
            <button
              className="m-2 px-8 py-2 border-4 border-black rounded-md text-lg font-semibold"
          ...
          <button
            className="m-2 px-8 py-2 border-4 bg-black border-black rounded-md text-lg text-white font-semibold"
