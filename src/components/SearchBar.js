      ...
      <div className="">
        <form className="relative mx-auto w-max">
          <input
            ...
            className="peer cursor-pointer text-sm relative z-10 h-10 w-12 rounded-full border-2 bg-transparent pl-10 outline-none focus:w-full focus:cursor-text focus:border-gray-400 focus:pl-10 focus:pr-4 transition-all ease-linear duration-400"
          />
          <svg
